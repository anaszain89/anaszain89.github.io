...
**PhD candidate with expertise in machine learning, computer vision techniques, image processing, and time-series analysis.** 

* * *
<div id="Summary" name="Summary">  </div>
# Brief Summary <a href="/index.html#Top"><i class="fas fa-link"></i></a>

My _PhD thesis_ project involves development of a **novel end-to-end software framework** for analysis of fMRI data of the human brain. Results from this work have been published in high-ranking journals such as **Neuroimage** and **Neuroimage: Clinical**, among others. I have additionally worked on **Computer Aided Diagnostics**, using methods for image characterization and predicting the presence/absence of disease. These projects have included proposing novel features (such as _Minkowksi Functionals_ and _Scaling Index Methods_) in medical imaging, exploring different _classification techniques_ and also hands on experience with various _Deep Learning_ networks and frameworks. Prior to joining the PhD program I have worked for three years with **Philips Healthcare**, India, as a _Field Service Engineer for Imaging Systems_ (specialization in **MRI**). 
...
<table>
  <tr>
    <td >Aug 2013 - December 2018 (expected)</td>
    <td>
...
| Python Frameworks | **NumPy, scikit-learn, Pandas, PyTorch, TensorFlow**|
